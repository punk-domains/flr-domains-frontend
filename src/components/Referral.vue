  ...
  <div class="row">
    <div class="col-md-12 mt-3">
      <div class="container text-center">
        ...
        <p> 
          Share this link and earn a 10% referral fee from each new domain mint made via this link!
        </p>
        ...
        <div class="row mt-1">
          <div class="col-md-6 offset-md-3">
            <input 
              ...
              :value="'https://flr.domains/?ref=' + this.getNameOrAddress"
              @click="copyToClipboard('https://flr.domains/?ref=' + this.getNameOrAddress)"
              readonly
            >
          </div>
        </div>
